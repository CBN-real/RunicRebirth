...
public class RunicKeyRingMenu extends AbstractContainerMenu {
    ...
    private static final TagKey<Item>[] RING_TAGS = new TagKey[]{
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "thumb_spell_ring")),
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "index_spell_ring")),
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "middle_spell_ring")),
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "ring_spell_ring")),
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "pinkie_spell_ring"))
    };

    private static final TagKey<Item> BASE_SPELL_RING_TAG =
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("curios", "spell_ring"));
