...
public class DyeableAcolyteSetItem extends DyeableMagicArmorItem {
    ...
    public DyeableAcolyteSetItem(Type type, Properties props, String armorName, List<SpellModifier> modifiers) {
        super(ModArmorMaterials.ACOLYTE, type, props, armorName, armorName, 0f, 0f, 0f, modifiers, DEFAULT_DYE_COLOR);
    }
}
