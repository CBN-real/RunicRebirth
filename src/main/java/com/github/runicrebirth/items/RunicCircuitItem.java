...
public class RunicCircuitItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, net.minecraft.world.item.component.TooltipDisplay display, java.util.function.Consumer<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.accept(Component.literal("Tier: " + tierName));
        ...
        if (isInscribed(stack)) {
            ...
            if (entry != null) {
                for (WandStacksData.ComponentRef ref : entry.components()) {
                    ...
                    if (component != null) {
                        if (component instanceof SpellType) {
                            tooltipComponents.accept(Component.literal("Spell: ").append(component.displayName()));
                        } else {
                            tooltipComponents.accept(Component.literal("Modifier: ").append(component.displayName()));
                        }
                    }
                }
                if (entry.elementId() != null) {
                    ...
                    if (element != null) {
                        ...
                        tooltipComponents.accept(Component.literal("Element: ")
            ...
            tooltipComponents.accept(Component.translatable("item.runicrebirth.runic_circuit.blank"));
        }

        tooltipComponents.accept(Component.literal("Modifier Slots: " + storedTier));
