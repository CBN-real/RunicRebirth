...
public class TatteredSectBannerItem extends RunicBlockItem {

    public TatteredSectBannerItem(Block block, Properties props) {
        super(block, props, "idle", "tattered_sect_banner");
    }
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos pos, Level level, @Nullable Player player,
        ...
        if (!level.isClientSide() && level.getBlockEntity(pos) instanceof TatteredSectBannerBlockEntity be) {
