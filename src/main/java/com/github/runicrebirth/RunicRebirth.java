...
import com.github.runicrebirth.datagen.DataGenHandler;
...
public class RunicRebirth {
    ...
    public RunicRebirth(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modEventBus.addListener(DataGenHandler::onGatherDataClient);
        modEventBus.addListener(DataGenHandler::onGatherDataServer);
