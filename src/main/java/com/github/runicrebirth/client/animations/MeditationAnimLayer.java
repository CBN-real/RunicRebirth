...
public class MeditationAnimLayer {
    ...
    public static final Identifier LAYER_ID =
            Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "meditation_layer");

    public static final Identifier MEDITATE_ANIM_ID =
            Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "meditate");
