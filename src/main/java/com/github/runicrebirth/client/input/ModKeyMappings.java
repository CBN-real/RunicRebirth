...
public final class ModKeyMappings {
    ...
    public static final KeyMapping.Category CATEGORY =
        KeyMapping.Category.register(Identifier.fromNamespaceAndPath("runicrebirth", "runicrebirth"));
    ...
    public static boolean isMovementKey(int keyCode, int scanCode) {
        ...
        InputConstants.Key pressed = InputConstants.Type.KEYSYM.getOrCreate(keyCode);
