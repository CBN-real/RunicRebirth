...
public class ZombifiedArtificerAcolyteRenderer<R extends LivingEntityRenderState & GeoRenderState>
    extends GeoEntityRenderer<ZombifiedArtificerAcolyteEntity, R> {
    ...
    @Override
    public void addRenderData(ZombifiedArtificerAcolyteEntity entity, Void relatedObject, R renderState, float partialTick) {
