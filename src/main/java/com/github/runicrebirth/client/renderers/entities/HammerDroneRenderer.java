...
@OnlyIn(Dist.CLIENT)
public class HammerDroneRenderer extends GeoEntityRenderer<HammerDroneEntity> {
    ...
    @Override
    public RenderType getRenderType(HammerDroneEntity entity, ResourceLocation texture,
    ...
    @Override
    protected void applyRotations(HammerDroneEntity entity, PoseStack poseStack,
