...
public class SkeletalMageAcolyteGeoModel extends GeoModel<SkeletalMageAcolyteEntity> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "entity/skeletal_mage_acolyte");
    ...
    @Override
    public Identifier getAnimationResource(SkeletalMageAcolyteEntity animatable) { return ANIMATIONS; }
