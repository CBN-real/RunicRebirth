...
public class InfusionCircleGeoModel extends GeoModel<InfusionCircleEntity> {
    ...
    private static final ResourceLocation MODEL =
            ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "geo/spell/infusion_circle.geo.json");
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID,
                    "textures/entity/runic_templates/arcane_runic_template.png");
    private static final ResourceLocation ANIMATIONS =
            ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "animations/spell/infusion_circle.animation.json");

    @Override
    public ResourceLocation getModelResource(InfusionCircleEntity entity) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(InfusionCircleEntity entity) {
        if (entity != null) {
    ...
    @Override
    public ResourceLocation getAnimationResource(InfusionCircleEntity entity) {
        return ANIMATIONS;
    }
}
