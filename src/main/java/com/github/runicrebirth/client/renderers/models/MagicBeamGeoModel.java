...
public class MagicBeamGeoModel extends GeoModel<MagicBeamEntity> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "spell/magic_beam");
    private static final Identifier TEXTURE =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "textures/entity/magic_beam/arcane_magic_beam_texture.png");
    ...
    public Identifier getTextureResource(GeoRenderState renderState) {
        ...
        if (elementId != null) {
            ...
            if (parsed != null) {
                return net.minecraft.resources.Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "textures/entity/magic_beam/" + parsed.getPath() + "_magic_beam_texture.png");
            }
        }
        return TEXTURE;
    }
    ...
    @Override
    public Identifier getAnimationResource(MagicBeamEntity animatable) {
        return ANIMATIONS;
    }
}
