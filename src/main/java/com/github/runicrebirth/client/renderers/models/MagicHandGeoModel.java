...
public class MagicHandGeoModel extends GeoModel<MagicHandEntity> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "spell/magic_hand");
    ...
    @Override
    public Identifier getAnimationResource(MagicHandEntity animatable) { return ANIMATIONS; }
}
