...
public class CrumblingPlatformRenderer implements BlockEntityRenderer<CrumblingPlatformBlockEntity, CrumblingPlatformRenderer.RenderState> {

    public static class RenderState extends BlockEntityRenderState {
        public @Nullable BlockState mimickedState;
    }
    ...
    @Override
    public void extractRenderState(CrumblingPlatformBlockEntity be, RenderState state, float partialTicks,
        ...
        state.mimickedState = be.getMimickedState();
    }
