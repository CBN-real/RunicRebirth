...
@OnlyIn(Dist.CLIENT)
public class MagicBallistaCircleRenderer extends AbstractSpellRenderer<MagicBallistaCircleEntity> {
    ...
    @Override
    protected void applyRotations(MagicBallistaCircleEntity entity, PoseStack poseStack,
    ...
    @Override
    public void preRender(PoseStack poseStack, MagicBallistaCircleEntity entity, BakedGeoModel model,
