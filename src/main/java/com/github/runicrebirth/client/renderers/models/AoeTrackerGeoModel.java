...
public class AoeTrackerGeoModel extends GeoModel<AoeTrackerEntity> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "spell/aoe_tracker");
    ...
    @Override
    public Identifier getAnimationResource(AoeTrackerEntity animatable) { return ANIMATIONS; }
}
