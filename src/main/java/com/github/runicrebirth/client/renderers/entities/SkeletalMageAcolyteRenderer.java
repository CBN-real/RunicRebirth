...
public class SkeletalMageAcolyteRenderer<R extends LivingEntityRenderState & GeoRenderState>
    extends GeoEntityRenderer<SkeletalMageAcolyteEntity, R> {
    ...
    @Override
    public void addRenderData(SkeletalMageAcolyteEntity entity, Void relatedObject, R renderState, float partialTick) {
