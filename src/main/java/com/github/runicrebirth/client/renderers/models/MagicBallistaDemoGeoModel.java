...
public class MagicBallistaDemoGeoModel extends GeoModel<SpellDemoEntity> {

    private static final ResourceLocation MODEL =
        ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "geo/spell/magic_ballista_full.geo.json");
    ...
    private static final ResourceLocation ANIMATIONS =
        ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "animations/spell/magic_ballista_full.animation.json");
