...
public class ZombifiedRunebladeAcolyteRenderer<R extends LivingEntityRenderState & GeoRenderState>
    extends GeoEntityRenderer<ZombifiedRunebladeAcolyteEntity, R> {
    ...
    @Override
    public void addRenderData(ZombifiedRunebladeAcolyteEntity entity, Void relatedObject, R renderState, float partialTick) {
