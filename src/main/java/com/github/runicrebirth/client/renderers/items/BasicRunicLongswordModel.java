...
public class BasicRunicLongswordModel extends GeoModel<BasicRunicLongsword> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "item/runic_longsword");
    private static final Identifier TEXTURE =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "textures/models/weapon/runic_longsword_texture.png");
    private static final Identifier ANIMATIONS =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "item/basic_runic_longsword");
    ...
    @Override
    public Identifier getAnimationResource(BasicRunicLongsword animatable) { return ANIMATIONS; }
}
