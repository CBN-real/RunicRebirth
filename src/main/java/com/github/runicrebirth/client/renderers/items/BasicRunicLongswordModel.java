...
public class BasicRunicLongswordModel extends GeoModel<BasicRunicLongsword> {
    ...
    private static final ResourceLocation MODEL =
        ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "geo/item/basic_runic_longsword.geo.json");
    private static final ResourceLocation TEXTURE =
        ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "textures/item/basic_runic_longsword.png");
