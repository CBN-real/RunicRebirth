...
public class MagicBallistaCircleGeoModel extends GeoModel<MagicBallistaCircleEntity> {
    ...
    private static final Identifier MODEL =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "spell/magic_ballista_circle");
    ...
    @Override
    public Identifier getAnimationResource(MagicBallistaCircleEntity animatable) {
        return ANIMATIONS;
    }
}
