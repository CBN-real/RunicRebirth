...
public class MagicArrowGeoModel extends GeoModel<MagicArrowEntity> {
  ...
  private static final ResourceLocation MODEL =
      ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "geo/spell/magic_arrow.geo.json");
  ...
  private static final ResourceLocation ANIMATIONS =
      ResourceLocation.fromNamespaceAndPath(RunicRebirth.MODID, "animations/spell/magic_arrow.animation.json");
    ...
    if (entity != null) {
      ...
      if (parsed != null) {
        return ResourceLocation.fromNamespaceAndPath(
            RunicRebirth.MODID,
            "textures/entity/runic_templates/" + parsed.getPath() + "_runic_template.png" //Reusing textures where possible
        );
      }
    }
    return TEXTURE;
