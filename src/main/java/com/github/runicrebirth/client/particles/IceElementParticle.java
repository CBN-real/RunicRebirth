...
public class IceElementParticle extends SimpleAnimatedParticle {

    
    private final boolean mirrored;

    public IceElementParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new IceElementParticle(level, x, y, z, this.sprites, dx, dy, dz, type.getScale());
        }
    }
}
