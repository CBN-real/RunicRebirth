...
public class IceInkParticle extends InkParticle {

    public IceInkParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new IceInkParticle(level, x, y, z, this.sprites, type.getScale());
        }
    }
}
