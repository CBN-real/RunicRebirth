...
public class ArcaneTinyParticle extends SimpleAnimatedParticle {

    
    private final boolean mirrored;

    public ArcaneTinyParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new ArcaneTinyParticle(level, x, y, z, this.sprites, dx, dy, dz, type.getScale());
        }
    }
}
