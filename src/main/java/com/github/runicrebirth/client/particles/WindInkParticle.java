...
public class WindInkParticle extends InkParticle {

    public WindInkParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new WindInkParticle(level, x, y, z, this.sprites, type.getScale());
        }
    }
}
