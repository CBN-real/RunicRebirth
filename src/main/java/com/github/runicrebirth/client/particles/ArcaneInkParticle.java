...
public class ArcaneInkParticle extends InkParticle {

    public ArcaneInkParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new ArcaneInkParticle(level, x, y, z, this.sprites, type.getScale());
        }
    }
}
