...
public class EarthTinyParticle extends SimpleAnimatedParticle {

    
    private final boolean mirrored;

    public EarthTinyParticle(ClientLevel level, double x, double y, double z,
    ...
    public void tick() {
        ...
        this.yd += this.random.nextFloat() / 500.0F * -1;
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new EarthTinyParticle(level, x, y, z, this.sprites, dx, dy, dz, type.getScale());
        }
    }
}
