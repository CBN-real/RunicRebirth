...
public class FireTinyParticle extends SimpleAnimatedParticle {

    
    private final boolean mirrored;

    public FireTinyParticle(ClientLevel level, double x, double y, double z,
    ...
    public void tick() {
        super.tick();
        this.xd += this.random.nextFloat() / 1000.0F * (this.random.nextBoolean() ? 1 : -1);
        this.yd += this.random.nextFloat() / 300.0F;
        this.zd += this.random.nextFloat() / 1000.0F * (this.random.nextBoolean() ? 1 : -1);
    ...
    public static class Provider implements ParticleProvider<ScaledParticleOption> {
        ...
        public Particle createParticle(ScaledParticleOption type, ClientLevel level,
            ...
            return new FireTinyParticle(level, x, y, z, this.sprites, dx, dy, dz, type.getScale());
        }
    }
}
