...
public final class CrackManager {
    ...
    private static final Identifier CRACK_TEXTURE =
        Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "textures/block/crack_texture.png");
    ...
    public static void onRenderLevel(RenderLevelStageEvent.AfterTranslucentBlocks event) {
        ...
        RenderType renderType = RenderTypes.entityTranslucentEmissive(CRACK_TEXTURE);
        ...
        for (CrackGroup group : CRACKS) {
            ...
            for (BlockPos pos : group.positions) {
                ...
                consumer.addVertex(pose, 0f, 0f, 0f).setColor(cr, cg, cb, ca)
                    ...
                    .setLight(15728880).setNormal(lastPose, 0f, 1f, 0f);
