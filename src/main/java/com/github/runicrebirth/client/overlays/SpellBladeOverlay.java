...
public class SpellBladeOverlay implements GuiLayer {
    ...
    private static void drawSlot(GuiGraphicsExtractor graphics, Minecraft mc, int x, int y,
    ...
    private static void drawWeaponKeyLabel(GuiGraphicsExtractor graphics, Minecraft mc, int x, int y) {
    ...
    private static void drawCooldownBar(GuiGraphicsExtractor graphics, ItemStack stack, int x, int y) {
        ...
        Identifier cdId = weapon.getWeaponCooldownId();
