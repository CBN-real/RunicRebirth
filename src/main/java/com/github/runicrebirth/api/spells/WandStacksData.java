...
public record WandStacksData(List<StackEntry> stacks, int activeIndex) {
    ...
    public record ComponentRef(int kind, Identifier id) {
        ...
        public static final Codec<ComponentRef> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            Identifier.CODEC.fieldOf("id").forGetter(ComponentRef::id)
        ...
        public static final StreamCodec<ByteBuf, ComponentRef> STREAM_CODEC = StreamCodec.of(
            ...
            buf -> {
                ...
                Identifier id = Identifier.parse(ByteBufCodecs.STRING_UTF8.decode(buf));
    ...
    public record StackEntry(
        ...
        @Nullable Identifier elementId,
        boolean inscribed,
        int permanentCount,
        int chargeCount,
        @Nullable Identifier chargedSpellId
    ) {
        ...
        public StackEntry withCharges(int count, Identifier spellId) {
        ...
        public static final Codec<StackEntry> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            Identifier.CODEC.optionalFieldOf("element").forGetter(e -> Optional.ofNullable(e.elementId)),
            ...
            Identifier.CODEC.optionalFieldOf("chargedSpellId").forGetter(e -> Optional.ofNullable(e.chargedSpellId))
        ...
        public static final StreamCodec<ByteBuf, StackEntry> STREAM_CODEC = StreamCodec.of(
            ...
            buf -> {
                ...
                Identifier elem = buf.readBoolean()
                    ? Identifier.parse(ByteBufCodecs.STRING_UTF8.decode(buf))
                    : null;
                boolean inscribed = buf.readBoolean();
                int pc = ByteBufCodecs.INT.decode(buf);
                int chargeCount = ByteBufCodecs.INT.decode(buf);
                Identifier chargedSpellId = buf.readBoolean()
                    ? Identifier.parse(ByteBufCodecs.STRING_UTF8.decode(buf))
                    : null;
