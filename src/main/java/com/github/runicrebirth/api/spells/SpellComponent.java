...
public sealed interface SpellComponent permits SpellType, SpellModifier {
    ...
    default Identifier getSpellIconPath() {
    ...
    default Identifier getOverlaySlotPath() {
        return Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "hud/overlay_slot_border_small");
    }
}
