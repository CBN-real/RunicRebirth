...
public class RunicAnvilRecipe implements Recipe<RunicAnvilRecipeInput> {
    ...
    public RunicAnvilRecipe(List<Ingredient> ingredients, ItemStack result, int craftingTime) {
    ...
    @Override
    public ItemStack assemble(RunicAnvilRecipeInput input, HolderLookup.Provider registries) {
        return result.copy();
    }
