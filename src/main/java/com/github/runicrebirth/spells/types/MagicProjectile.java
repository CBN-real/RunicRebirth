...
public class MagicProjectile extends SpellType {
    ...
    public static final Identifier ID = Identifier.fromNamespaceAndPath(RunicRebirth.MODID, "magic_projectile");
    ...
    @Override public float spellHeight() { return 0.25f * this.baseSize(); }
