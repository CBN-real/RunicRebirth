...
public class RunesteelCacheBlockEntity extends BlockEntity implements GeoBlockEntity, MenuProvider, Container {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<RunesteelCacheBlockEntity>("controller", 0, state -> {
    ...
    protected void saveAdditional(ValueOutput output) {
        ...
        output.putInt("AnimState", animState);
    }
    ...
    public void loadAdditional(ValueInput input) {
        ...
        animState = (byte) input.getIntOr("AnimState", 0);
        if (animState == 2) {
            animState = 0;
            closingTicks = 0;
        }
