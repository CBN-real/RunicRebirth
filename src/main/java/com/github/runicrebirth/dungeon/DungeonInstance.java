...
public class DungeonInstance {
    ...
    private final Identifier returnDimension;
    ...
    public DungeonInstance(UUID instanceId, Identifier tierId, @Nullable Identifier variantId,
                           int difficulty, BlockPos origin, BlockPos returnPos,
                           Identifier returnDimension, int durationTicks) {
    ...
    @Nullable
    public Identifier getVariantId() { return variantId; }
    public int getDifficulty() { return difficulty; }
    public BlockPos getOrigin() { return origin; }
    public BlockPos getReturnPos() { return returnPos; }
    public Identifier getReturnDimension() { return returnDimension; }
