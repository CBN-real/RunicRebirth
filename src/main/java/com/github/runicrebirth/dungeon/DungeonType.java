...
public enum DungeonType {
    ...
    private final Identifier requiredElement;
    private final String description;

    DungeonType(String path, String displayName, GenerationMode generationMode,
                int maxDifficulty, Identifier requiredElement, String description) {
        this.id = Identifier.fromNamespaceAndPath(RunicRebirth.MODID, path);
    ...
    public Identifier getRequiredElement() { return requiredElement; }
    ...
    public Identifier getElementUnlock() {
        return switch (this) {
            case FIRE_TRIAL -> Identifier.parse("runicrebirth:fire");
            case ICE_TRIAL -> Identifier.parse("runicrebirth:ice");
            case WIND_TRIAL -> Identifier.parse("runicrebirth:wind");
            case EARTH_TRIAL -> Identifier.parse("runicrebirth:earth");
            default -> null;
        };
    }

    public static DungeonType byId(Identifier id) {
