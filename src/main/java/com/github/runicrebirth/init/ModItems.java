...
public static final DeferredItem<RingOfExpansionItem> RING_OF_EXPANSION = ITEMS.registerItem(
    ...
    public static final DeferredItem<BlockItem> ARCANE_RUNIC_STONE_BRICKS_SLAB = ITEMS.registerSimpleBlockItem(ModBlocks.ARCANE_RUNIC_STONE_BRICKS_SLAB);
    public static final DeferredItem<BlockItem> ARCANE_RUNIC_STONE_BRICKS_STAIRS = ITEMS.registerSimpleBlockItem(ModBlocks.ARCANE_RUNIC_STONE_BRICKS_STAIRS);
    public static final DeferredItem<BlockItem> ARCANE_RUNIC_STONE_BRICKS_WALL = ITEMS.registerSimpleBlockItem(ModBlocks.ARCANE_RUNIC_STONE_BRICKS_WALL);
