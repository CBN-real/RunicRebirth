...
public final class UnlockRegistry {
    ...
    private static final Map<ResourceLocation, UnlockEntry> BY_ID = new LinkedHashMap<>();
    ...
    private static ResourceLocation rl(String path) {
        return ResourceLocation.fromNamespaceAndPath("runicrebirth", path);
    }
    ...
    public static Optional<UnlockEntry> byId(ResourceLocation id) {
