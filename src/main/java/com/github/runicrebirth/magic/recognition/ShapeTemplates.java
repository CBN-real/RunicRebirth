...
public final class ShapeTemplates {
    ...
    public static final Identifier ID_CIRCLE     = id("circle");
    public static final Identifier ID_TRIANGLE   = id("triangle");
    public static final Identifier ID_LINE_DOWN  = id("line_down");
    public static final Identifier ID_PLUS       = id("plus");
    public static final Identifier ID_V          = id("v_shape");
    public static final Identifier ID_INFUSION   = id("infusion");
    public static final Identifier ID_ARROW      = id("arrow");
    public static final Identifier ID_EXPLOSION  = id("explosion");
    public static final Identifier ID_SLASH      = id("slash");
    public static final Identifier ID_METEOR     = id("meteor");
    public static final Identifier ID_SHIELD     = id("shield");
    public static final Identifier ID_HAMMER     = id("hammer");
    public static final Identifier ID_BINDING    = id("binding");
    public static final Identifier ID_BALLISTA   = id("ballista");
    public static final Identifier ID_COOLDOWN   = id("cooldown");
    public static final Identifier ID_RANGE      = id("range");
    public static final Identifier ID_TWO_CASTS  = id("two_casts");
    public static final Identifier ID_FOUR_CASTS = id("four_casts");
    public static final Identifier ID_CHARGES       = id("charges");
    public static final Identifier ID_CHARGES_THREE = id("three_charges");
    public static final Identifier ID_CHARGES_FOUR  = id("four_charges");
    public static final Identifier ID_PLUS_TWO   = id("plus_two");
    public static final Identifier ID_PLUS_FOUR  = id("plus_four");
    public static final Identifier ID_SHARP_BOOST = id("sharp_boost");
    public static final Identifier ID_BLUNT_BOOST = id("blunt_boost");
    public static final Identifier ID_MAGIC_BOOST = id("magic_boost");
