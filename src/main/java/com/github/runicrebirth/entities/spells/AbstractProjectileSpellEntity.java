...
public abstract class  AbstractProjectileSpellEntity extends ThrowableProjectile implements GeoEntity, ScaledSpellEntity, com.github.runicrebirth.api.spells.ElementalEntity {
    ...
    protected void scanWideBoundingBoxHits() {
        ...
        if (getPhase() == SpellPhase.ACTIVE && !this.level().noCollision(this, swept)) {
            ...
            if (blockHit.getType() != HitResult.Type.MISS) {
                ...
                Direction dir = Direction.getNearest((int)-movement.x, (int)-movement.y, (int)-movement.z, Direction.NORTH);
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<AbstractProjectileSpellEntity>("spell_phase", 0, state -> {
            if (!this.isAddedToLevel()) {
            ...
            } else if (state.animatable().getPhase() == SpellPhase.ACTIVE) {
