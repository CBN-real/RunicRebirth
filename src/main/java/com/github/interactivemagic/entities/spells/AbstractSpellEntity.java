...
public abstract class AbstractSpellEntity extends Entity implements GeoEntity {
    ...
    private static final EntityDataAccessor<String> DATA_ELEMENT =
        SynchedEntityData.defineId(AbstractSpellEntity.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Float> DATA_SIZE =
        SynchedEntityData.defineId(AbstractSpellEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> DATA_PHASE =
        SynchedEntityData.defineId(AbstractSpellEntity.class, EntityDataSerializers.INT);
    ...
    protected AbstractSpellEntity(EntityType<? extends AbstractSpellEntity> type, Level level) {
        super(type, level);
        this.noPhysics = true;
