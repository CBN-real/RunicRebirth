...
public class MagicHammer extends SpellType {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(InteractiveMagic.MODID, "magic_hammer");
    ...
    public CastResult onCast(SpellCastContext ctx, SpellParams params) {
        ...
        MagicHammerEntity hammer = new MagicHammerEntity(ctx.level(), ctx.caster(), params, directDmg, splashDmg);
