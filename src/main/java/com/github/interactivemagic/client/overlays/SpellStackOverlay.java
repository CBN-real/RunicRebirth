...
import com.github.interactivemagic.spells.modifiers.ChargesModifier;
import com.github.interactivemagic.spells.modifiers.MultiCastModifier;
...
public class SpellStackOverlay implements LayeredDraw.Layer {
    ...
    private static final ResourceLocation SLOT_BIG_EMPTY =
        ResourceLocation.fromNamespaceAndPath("interactivemagic", "hud/overlay_slot_border");
    private static final ResourceLocation SLOT_SMALL_FILLED =
        ResourceLocation.fromNamespaceAndPath("interactivemagic", "hud/overlay_slot_border_small");
    private static final ResourceLocation SLOT_SMALL_UNAVAIL =
        ResourceLocation.fromNamespaceAndPath("interactivemagic", "hud/overlay_slot_border_small_unavail");
    private static final ResourceLocation SLOT_SELECTED =
        ResourceLocation.fromNamespaceAndPath("interactivemagic", "hud/overlay_slot_border_selected");
    private static final ResourceLocation CHARGE_ICONS =
        ResourceLocation.fromNamespaceAndPath("interactivemagic", "textures/gui/sprites/hud/charge_icons.png");
