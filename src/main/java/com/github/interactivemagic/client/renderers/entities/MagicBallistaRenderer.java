...
import com.github.interactivemagic.client.renderers.models.MagicBallistaGeoModel;
...
@OnlyIn(Dist.CLIENT)
public class MagicBallistaRenderer extends GeoEntityRenderer<MagicBallistaEntity> {
    ...
    @Override
    public RenderType getRenderType(MagicBallistaEntity entity, ResourceLocation texture,
        @Nullable MultiBufferSource bufferSource, float partialTick) {
        return ModRenderTypes.entityTranslucentNoDepth(texture);
    }

    @Override
    public void preRender(PoseStack poseStack, MagicBallistaEntity entity, BakedGeoModel model,
