...
import com.github.interactivemagic.client.renderers.models.MagicHammerGeoModel;
...
@OnlyIn(Dist.CLIENT)
public class MagicHammerRenderer extends GeoEntityRenderer<MagicHammerEntity> {
