...
import com.github.interactivemagic.client.renderers.models.MagicSlashGeoModel;
...
@OnlyIn(Dist.CLIENT)
public class MagicSlashRenderer extends GeoEntityRenderer<MagicSlashEntity> {
    ...
    @Override
    public RenderType getRenderType(MagicSlashEntity entity, ResourceLocation texture,
        @Nullable MultiBufferSource bufferSource, float partialTick) {
        return ModRenderTypes.entityTranslucentNoDepth(texture);
    }

    @Override
    public void preRender(PoseStack poseStack, MagicSlashEntity entity, BakedGeoModel model,
