package com.github.interactivemagic.client.input;
...
public final class ModKeyMappings {
    ...
    public static final String CATEGORY = "key.categories.interactivemagic";

    public static final KeyMapping SWITCH_SPELL_STACK = new KeyMapping(
        "key.interactivemagic.switch_spell_stack",
