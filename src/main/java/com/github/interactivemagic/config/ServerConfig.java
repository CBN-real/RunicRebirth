package com.github.interactivemagic.config;
...
public final class ServerConfig {
    ...
    public static final ModConfigSpec.IntValue MAGIC_CONE_COOLDOWN;
    public static final ModConfigSpec.DoubleValue MAGIC_CONE_BASE_DAMAGE;
    ...
    static {
        ...
        b.pop();
        b.push("magic_cone");
        MAGIC_CONE_COOLDOWN = b.defineInRange("cooldownTicks", 120, 0, 6000);
        MAGIC_CONE_BASE_DAMAGE = b.defineInRange("baseDamage", 2.5, 0.0, 100.0);
        b.pop();
        b.push("magic_arrow");
    ...
    public static void onLoad(ModConfigEvent.Loading event) {
        InteractiveMagic.LOGGER.info("[InteractiveMagic] ServerConfig loaded");
    }
}
